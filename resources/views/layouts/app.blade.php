...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <img src="asset/img/default-user-image.webp" class="user-image img-circle elevation-2" alt="User Image">
                        <span class="d-none d-md-inline">{{ Auth::user()->name }}</span>
                    </a>
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        <!-- User image -->
                        <li class="user-header bg-primary">
                            <img src="asset/img/default-user-image.webp" class="img-circle elevation-2" alt="User Image">
                            <p>
                                {{ Auth::user()->name }}
        ...
        <footer class="main-footer">
            ...
            <strong>&copy; 2021 Made by <a href="https://fiqihfatwa.github.io" target="_blank">Fiqih Fatwa</a>.</strong> All rights
            reserved.
        </footer>
    </div>
